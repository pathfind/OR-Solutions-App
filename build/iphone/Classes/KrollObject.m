...
//@interface ORSolutionsObject : NSObject
//@end

@interface ORSolutionsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ORSolutionsObject class]])
		{
			for (NSString *key in [[(ORSolutionsObject*)o modules] allKeys])
			{
