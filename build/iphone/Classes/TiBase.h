...
// in simulator we redefine to format for ORSolutions Developer console
...
{\
	NSString * exceptionName = [@"org.orsolutions." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.orsolutions";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIORSolutionsNativeItemNone = -1, 
	UIORSolutionsNativeItemSpinner = -2,
	UIORSolutionsNativeItemProgressBar = -3,
	
	UIORSolutionsNativeItemSlider = -4,
	UIORSolutionsNativeItemSwitch = -5,
	UIORSolutionsNativeItemMultiButton = -6,
	UIORSolutionsNativeItemSegmented = -7,
	
	UIORSolutionsNativeItemTextView = -8,
	UIORSolutionsNativeItemTextField = -9,
	UIORSolutionsNativeItemSearchBar = -10,
	
	UIORSolutionsNativeItemPicker = -11,
	UIORSolutionsNativeItemDatePicker = -12,
	
	UIORSolutionsNativeItemInfoLight = -13,
	UIORSolutionsNativeItemInfoDark = -14,
	
	UIORSolutionsNativeItemDisclosure = -15,
	
	UIORSolutionsNativeItemContactAdd = -16
};
